 ...
 *
 */
public class ZoneFailoverAwarenessLoadBalancerCacheDataManager implements LoadBalancerCacheDataManager {

	private static final String CACHE_KEY_FAILED = "FAILED";

	private final LoadBalancerCacheManager cacheManager;

	public ZoneFailoverAwarenessLoadBalancerCacheDataManager(LoadBalancerCacheManager cacheManager) {
