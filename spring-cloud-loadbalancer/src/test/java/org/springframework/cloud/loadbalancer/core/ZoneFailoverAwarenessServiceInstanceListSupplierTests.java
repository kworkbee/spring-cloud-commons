 ...
 *
 */
class ZoneFailoverAwarenessServiceInstanceListSupplierTests {
	...
	private final ZoneFailoverAwarenessLoadBalancerCacheDataManager cacheDataManager = mock(
			ZoneFailoverAwarenessLoadBalancerCacheDataManager.class);

	private final ZoneFailoverAwarenessServiceInstanceListSupplier supplier = new ZoneFailoverAwarenessServiceInstanceListSupplier(
