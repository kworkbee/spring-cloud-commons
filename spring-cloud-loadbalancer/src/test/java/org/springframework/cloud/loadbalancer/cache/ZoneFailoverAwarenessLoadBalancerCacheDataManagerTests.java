 ...
 *
 */
class ZoneFailoverAwarenessLoadBalancerCacheDataManagerTests {
	...
	private final ZoneFailoverAwarenessLoadBalancerCacheDataManager cacheDataManager = new ZoneFailoverAwarenessLoadBalancerCacheDataManager(
			cacheManager);
